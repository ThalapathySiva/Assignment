...
public class p1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Picasso.with(getApplicationContext()).load("https://firebasestorage.googleapis.com/v0/b/assingnment-8e608.appspot.com/o/78db55ec23a4e1acbcae16cfce5f253b.jpg?alt=media&token=b23f87cc-54ca-456d-b786-bf88d828c470").into(pi);
