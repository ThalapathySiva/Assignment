...
public class p2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Picasso.with(getApplicationContext()).load("https://firebasestorage.googleapis.com/v0/b/assingnment-8e608.appspot.com/o/Michael_Avatar_beard.jpg?alt=media&token=5e9490fa-9e59-4c62-ab4e-3cbae32a6179").into(pi);
        database= FirebaseDatabase.getInstance();
        as=database.getReference("Electrician");
        sa=as.child("Sivaperumal");
