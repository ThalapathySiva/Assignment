...
public class p4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Picasso.with(getApplicationContext()).load("https://firebasestorage.googleapis.com/v0/b/assingnment-8e608.appspot.com/o/profile_picture_by_des522-d57u8yz.jpg?alt=media&token=535e8c87-f2a7-4996-b536-760ebfc4a7e9").into(pi);
